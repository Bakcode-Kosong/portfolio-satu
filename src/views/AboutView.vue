      ...
      >
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Fajar Ramadhan. I'm a
            web developer from Medan, North Sumatra. I have 1 year of experience
            in back-end web development. I really enjoy what I do right now, in
          ...
          <p class="mb-3 fadein-left fadeins-2">
            ...
            in hiring me, please contact the listed contact. email :
            bakcode.kosong@gmail.com
          </p>
        </div>
      </section>
    </article>
